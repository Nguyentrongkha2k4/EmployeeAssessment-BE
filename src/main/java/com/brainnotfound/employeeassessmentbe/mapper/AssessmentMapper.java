...
public class AssessmentMapper {
    ...
    public AssessmentResponse toAssessmentDto(Assessment assessment) {
        return new AssessmentResponse(assessment.getId(), assessment.getUser().getId(), assessment.getCriteria().getId(), assessment.getScore(), assessment.getComment(), assessment.getUpdateAt());
    }
}
